...
INSERT INTO `historial_partidas` VALUES (1,3,'2023-01-06 01:23:00',1,1,3,1,1,8,1,7),(2,2,'2023-01-04 10:00:00',2,2,2,1,1,NULL,2,5),(3,1,'2023-01-04 12:00:00',2,2,3,1,1,NULL,2,6);
...
INSERT INTO `partidas_jugadores` VALUES (17,1,3),(18,1,4);
...
CREATE TABLE `puntajes` (
  ...
  PRIMARY KEY (`id`),
  KEY `puntajes_FK` (`id_equipo`),
  KEY `puntajes_FK_1` (`id_jugador`),
  CONSTRAINT `puntajes_FK` FOREIGN KEY (`id_equipo`) REFERENCES `equipos` (`id`) ON DELETE SET NULL,
  CONSTRAINT `puntajes_FK_1` FOREIGN KEY (`id_jugador`) REFERENCES `jugadores` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `puntajes` VALUES (1,'2',NULL,NULL);
...
-- Dump completed on 2023-01-06 13:02:41
