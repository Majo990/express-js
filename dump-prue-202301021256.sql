...
CREATE TABLE `arbitros` (
  ...
  `nombre_paises` varchar(10) DEFAULT NULL,
  `nombre_ciudades` varchar(10) DEFAULT NULL,
...
INSERT INTO `arbitros` VALUES (5,'Mario','Perez','Angola','Cacole',22,'Masculino',1.55,55,'2000-01-02'),(6,'Juan','Montero','Algeria','Batna City',22,'Masculino',1.6,50,'2000-01-18'),(7,'Celeste','Gonzales','Australia','Aberfoyle',28,'Femenino',1.7,60,'1999-06-20');
...
INSERT INTO `comportamientos` VALUES (1,'Actitud Positiva',NULL,5,NULL),(2,'Actitud Negativa no respeto las reglas',NULL,6,2),(3,'Actitud Positiva respeto las reglas',NULL,7,NULL);
...
CREATE TABLE `entrenadores` (
  ...
  `nombre_paises` varchar(10) NOT NULL,
  `nombre_ciudades` varchar(10) NOT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `entrenadores` VALUES (1,'Jose',NULL,'Castro',30,'Masculino','1999-01-12','Angola','Camabatela'),(2,'Rafael',NULL,'Mogollon',22,'Femenino','2000-01-20','Albania','Elbasan'),(3,'Angela',NULL,'Perleche',20,'Femenino','2002-12-05','Algeria','Annaba');
...
INSERT INTO `equipos` VALUES (1,'Breaking Bad','Peru','Lima','2000-12-02',2,1,'equipo ganador eliminatoria 2019','polo y short celeste','Pedro Caseres','Bad',1,'candado.png');
...
INSERT INTO `estadios` VALUES (1,'Estadio Nacional Perú ',2,NULL,'natural','Miguel Dasso','Gobierno del Perú ',150101,'Estadio Nacional, Paseo de la Republica Avenue 652, Lima, Lima 15046','Peru','Lima');
...
INSERT INTO `faltas` VALUES (4,2,'2022-12-30 12:15:00',NULL,6,NULL,NULL),(5,2,'2022-12-30 12:15:00',NULL,6,NULL,NULL),(6,2,'2022-12-30 12:15:00',NULL,6,NULL,NULL);
...
INSERT INTO `jueces` VALUES (1,'Victor','Carrasco','1999-02-22',30,'Masculino','Australia','Abbotsford');
...
INSERT INTO `jugadores` VALUES (1,'Pedro Gallese ','Peruana',1,32,'Masculino',5,1,1,3,1.89,0.77,'Peru','Miraflores'),(2,'Paolo Guerrero ','peruana',1,39,'Masculino',5,1,1,2,1.85,0.77,'Peru','Lima'),(3,'Fabiola','peruana',2,23,'Femenino',6,1,1,2,1.8,70,'Argentina','Acevedo');
...
INSERT INTO `partidas` VALUES (1,'Partidauno','Eliminatorias ',1,'2023-01-02','11:00:00','01:00:00','12:00:00',3,NULL,'Tenis'),(2,'Partidados','Partida selección equipo ',1,'2023-01-03','12:00:00','01:00:00','01:00:00',2,NULL,'Fútbol');
...
INSERT INTO `partidas_jugadores` VALUES (3,2,3),(4,2,2),(5,1,1),(6,1,3);
...
INSERT INTO `premios` VALUES (1,'Trofeo',1,2,'Trofeos');
...
INSERT INTO `torneos` VALUES (1,'Eliminación ','2023-01-02','Albania','Tirana',1);
...
INSERT INTO `usuarios` VALUES (3,'majo3','3a503ea4045304e3eb82b76eaf0903a0',NULL),(4,'majo','f0832159af15968232ea007347f31827',NULL);
...
-- Dump completed on 2023-01-02 12:56:28
